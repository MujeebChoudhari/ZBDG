		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#gbwfcerbudgetapprovecerbudgetapprove-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gbwfcerbudgetapprovecerbudgetapprove-display": {
								"semanticObject": "gbwfcerbudgetapprovecerbudgetapprove",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gb.wf.cer.budget.approve.cer.budget.approve",
									"url": sap.ui.require.toUrl("gb/wf/cer/budget/approve/cer/budget/approve")
								}
							}
						}
					}
